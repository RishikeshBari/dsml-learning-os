...
export function AppShell() {
  ...
  return (
    <div className="min-h-dvh bg-ink-50 text-ink-950 dark:bg-ink-950 dark:text-white lg:h-dvh lg:overflow-hidden">
      <div className="mx-auto flex min-h-dvh w-full max-w-[1440px] lg:h-full lg:min-h-0">
        <aside className="hidden h-full w-72 shrink-0 overflow-y-auto border-r border-ink-200/80 bg-white/80 px-5 py-6 backdrop-blur dark:border-white/15 dark:bg-white/[0.03] lg:block">
        ...
        <div className="flex min-w-0 flex-1 flex-col lg:h-full lg:min-h-0 lg:overflow-hidden">
          <header className="sticky top-0 z-30 shrink-0 border-b border-ink-200/70 bg-white/90 px-4 py-3 backdrop-blur dark:border-white/10 dark:bg-ink-950/90 sm:px-6">
          ...
          <main className="min-h-0 flex-1 bg-ink-50 px-4 py-6 pb-24 dark:bg-ink-950 sm:px-6 lg:overflow-y-auto lg:overscroll-contain lg:py-8 lg:pb-8">
            <Outlet />
          </main>
        </div>
      </div>
